package com.schneider.jersey.rest.jerseyrestapi.resource;

import com.schneider.jersey.rest.jerseyrestapi.bean.StockHolder;
import com.schneider.jersey.rest.jerseyrestapi.util.Validator;
...
public class StockResource {
    ...
    public Response getStockPrice(@QueryParam("status") @DefaultValue("0") String status) {
        System.out.println("Status of the api executed:"+Integer.parseInt(status));
