...
public class Task implements Runnable{
	...
	public void run() {
	    ...
	    System.out.println("state after interruption: "+Thread.currentThread().getState());
		System.out.println("unable to retreive the ping status because of interruption");
		}
