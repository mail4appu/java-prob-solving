...
public class TrackResource {        
    @GET
    @Path("/{id}")
    @Produces("application/vnd.musicstore-v1+json, application/vnd.musicstore-v1+xml")    
    ...
    @GET
    @Path("/{id}")
    @Produces("application/vnd.musicstore-v2+json, application/vnd.musicstore-v2+xml")
    public TrackV2 getV2(@PathParam("id") int id) {
        return new TrackV2("Apparao", "Jackhammer Blues", 150, 1941);
    }
}
